...
import com.lifeteam.farbeat.bridge.util.data.Res;
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Res.color(getContext(), R.color.checked));
            } else {
                itemView.setTextColor(Res.color(getContext(), R.color.gray9));
            }
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Res.color(getContext(), R.color.checked));
