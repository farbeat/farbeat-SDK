...
public class ViewfinderView extends View {
    ...
    private void init(@NotNull Context context, AttributeSet attrs) {
        ...
        frameRatio = array.getFloat(R.styleable.ViewfinderView_frameRatio, 0.85f);
     ...
     * @param frame
     */
    private void drawLineScanner(Canvas canvas, @NotNull Rect frame) {
        //线性渐变
     ...
     * @param frame
     */
    private void drawGridScanner(Canvas canvas, @NotNull Rect frame) {
        int stroke = 2;
     ...
     * @param frame
     */
    private void drawFrame(@NotNull Canvas canvas, @NotNull Rect frame) {
