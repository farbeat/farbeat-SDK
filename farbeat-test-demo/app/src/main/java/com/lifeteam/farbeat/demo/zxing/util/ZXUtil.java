package com.lifeteam.farbeat.demo.zxing.util;
...
public class ZXUtil {
    ...
    public static Bitmap createQRImage(String url, int color) {
        return createQRImage(url, 400, 400, color);
    }
     ...
     */
    @Nullable
    public static Bitmap createQRImage(String url, int width, int height, int color) {
        try {
            // 判断URL合法性
